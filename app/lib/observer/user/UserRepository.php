...
class UserRepository implements \SplSubject {
    ...
    public function notify(string $event = "*", $data = null): void {
        Log::alert("UserRepository: Broadcasting the '$event' event");
    ...
    public function initialize($filename): void {
        Log::alert('UserRepository: Loading user records from a file');
        // ...
        $this->notify("users:init", $filename);
    }

    public function createUser(array $data): User {
        Log::alert('UserRepository: Creating a user');
    ...
    public function updateUser(User $user, array $data): ?User {
        Log::alert('UserRepository: Updating a user');
    ...
    public function deleteUser(User $user): void {
        Log::alert('UserRepository: Deleting a user');
